...
const envSchema = z.object({
  ...
  PROTOCOL_TREASURY_CONTRACT: optionalStringSchema,
  PROTOCOL_REWARDS_CONTRACT: optionalStringSchema,
  PROTOCOL_SLASHING_COURT_CONTRACT: optionalStringSchema,
...
const protocolAddressEntries = {
  ...
  PROTOCOL_TREASURY_CONTRACT: raw.PROTOCOL_TREASURY_CONTRACT,
  PROTOCOL_REWARDS_CONTRACT: raw.PROTOCOL_REWARDS_CONTRACT,
  PROTOCOL_SLASHING_COURT_CONTRACT: raw.PROTOCOL_SLASHING_COURT_CONTRACT
};
...
export const env = Object.freeze({
  ...
  PROTOCOL_TREASURY_CONTRACT: normalizedProtocolAddresses.PROTOCOL_TREASURY_CONTRACT,
  PROTOCOL_REWARDS_CONTRACT: normalizedProtocolAddresses.PROTOCOL_REWARDS_CONTRACT,
  PROTOCOL_SLASHING_COURT_CONTRACT: normalizedProtocolAddresses.PROTOCOL_SLASHING_COURT_CONTRACT,
